package com.caixy.onlineJudge.models.vo.submit;
 ...
 *
 * @Author CAIXYPROMISE
 * @name com.caixy.onlineJudge.models.vo.submit.QuestionSubmitVO
...
public class QuestionSubmitVO implements Serializable
{
    ...
    public static QuestionSubmit voToObj(QuestionSubmitVO questionSubmitVO)
    {
        ...
        {
            questionSubmit.setJudgeInfo(JsonUtils.toJson(judgeInfoObj));
        }
    ...
    public static QuestionSubmitVO objToVo(QuestionSubmit questionSubmit)
    {
        ...
        questionSubmitVO.setJudgeInfo(JsonUtils.jsonToObject(judgeInfoStr, JudgeInfo.class));
