package com.caixy.onlineJudge.business.judge.manager.impl;
...
import com.caixy.onlineJudge.models.dto.question.JudgeConfig;
...
import com.caixy.onlineJudge.models.enums.sandbox.JudgeInfoMessageEnum;
 ...
 *
 * @Author CAIXYPROMISE
 * @name com.caixy.onlineJudge.business.judge.manager.impl.JavaStrategyImpl
 * @since 2024/9/11 下午5:14
 */
...
public class JavaStrategyImpl implements JudgeStrategy
{
    ...
    public JudgeInfo doJudge(JudgeContext judgeContext)
    {
        ...
        JudgeInfoMessageEnum judgeInfoMessageEnum = JudgeInfoMessageEnum.APPROVED;
