 ...
 *
 * @Author CAIXYPROMISE
 * @name com.caixy.onlineJudge.business.judge.sandbox.python.Python3SandBoxConstants
 * @since 2024/9/11 上午2:30
 */
public interface Python3SandBoxConstant
{
    /**
     * 待运行代码的存放文件名
     */
    String GLOBAL_PYTHON_FILE_NAME = "Main.py";
     ...
     */
    String MEMORY_LIMIT_PREFIX_CODE =
            "import resource;\n" +
            "max_memory = 128;\n" +
