...
public interface RabbitMQMessageHandler<T>
{
     ...
     */
    void handleMessage(Channel channel, Message message, String messageId) throws Exception;
     ...
     * @throws Exception 处理消息过程中可能抛出的异常
     */
    void handleDeadLetterMessage(Channel channel, Message message) throws Exception;
}