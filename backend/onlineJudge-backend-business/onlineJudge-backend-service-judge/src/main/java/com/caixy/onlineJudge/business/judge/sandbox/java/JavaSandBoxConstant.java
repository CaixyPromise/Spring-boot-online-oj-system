 ...
 *
 * @Author CAIXYPROMISE
 * @name com.caixy.onlineJudge.business.judge.sandbox.java.JavaSandBoxConstants
 * @since 2024/9/11 上午2:23
 */
public interface JavaSandBoxConstant
{
    /**
     * 待运行代码的存放文件名
     */
     ...
     * Java安全管理器类存放路径
     */
     String SECURITY_MANAGER_PATH = System.getProperty("user.dir");

    /**
     * Java安全管理器类名
     */
      String SECURITY_MANAGER_CLASS_NAME = "NowSecurityManager";
