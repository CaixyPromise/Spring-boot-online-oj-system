package com.caixy.onlineJudge.cache.redis;

import com.caixy.onlineJudge.models.enums.redis.RedisKeyEnum;
import com.caixy.onlineJudge.json.JsonUtils;
...
public class RedisUtils
{
     ...
     */
    public void setHashMap(RedisKeyEnum Enum, Map<String, Object> data, String... item)
    {
